    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.aboutText} numberOfLines={expanded ? undefined : 4}>{aboutText}</Text>
        ...
        <View style={styles.section}>
          ...
          {LIVE_UPDATES.map((u, i) => (
            <View key={i} style={[styles.updateItem, i === LIVE_UPDATES.length - 1 && { borderBottomWidth: 0 }]}>
              <View style={styles.updateEmoji}><Text style={{ fontSize: 20 }}>{u.emoji}</Text></View>
...
const styles = StyleSheet.create({
  ...
  donateBtn: { backgroundColor: '#1B8A4C', paddingVertical: 16, borderRadius: 14, alignItems: 'center' },
